...
public class VideoTrashActivity extends AppCompatActivity implements MyRecyclerViewAdapter.ItemClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_trash);
    ...
    private void loadImages() {
        ...
        RecyclerView recyclerView = findViewById(R.id.recycler_trash_video);
    ...
    public void recoverOnClicked(View view) {
        for (File f : selectedImages) {
            renameFile(f, HideFile.restoreDelete(f), 1);
        }
        loadImages();
        Toast.makeText(this, "Videos Recovered", Toast.LENGTH_LONG).show();
    }
    ...
    public void deleteOnClicked(View view) {
        ...
        loadImages();
        Toast.makeText(this, "Videos Deleted", Toast.LENGTH_LONG).show();
    }
}
